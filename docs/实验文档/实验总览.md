...
**数据文件**：`data/energy_profiling/expanded_profiling_20260515_031015.csv`（原始数据仅本地保留，可由 `src/experiments/run_finegrained_profiling.py` 重新生成）
**汇率表**：`data/rate_tables/dvfs_rules_20260515_045753.json`（原始数据仅本地保留）
**结果记录**：见 [文档索引](README.md) 中"核心实验结论"一节
...
├── 实验1-混合阶段能耗分析.md
├── 实验2-分阶段能耗分析.md
├── PHASE1_COMPLETION_REPORT.md          （阶段记录）
├── PHASE2_COMPLETION_REPORT.md          （阶段记录）
├── PHASE2_ANALYSIS_REPORT.md            （阶段记录）
├── PHASE3_COMPLETION_REPORT.md          （阶段记录）
├── PHASE6_FINEGRAINED_DVFS_REPORT.md    （阶段记录）
├── EnergyInfra_Phase6_实验分析总结_更新版.md
├── FINAL_SOLUTIONS_SUMMARY.md
